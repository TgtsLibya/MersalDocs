...
| -------------- | -------- | ------------------------------------------------------------- |
| `id`           | `String` | The ID of the order as stored in the service database         |
| `orderTitle`   | `String` | A custom title made by the customer for identifying the order |
| `serviceId`    | `String` | The friendly identifier stored in Mersal's order templates    |
| `serviceTitle` | `String` | The title of the service the customer is requesting           |

#### Responses

| Status Code        | Body Type                   | Description                                                |
| ------------------ | --------------------------- | ---------------------------------------------------------- |
| 200 (OK)           | [MersalOrder](#mersalorder) | The message has successfully been submitted to the `Order` |
...
```csharp
public class MersalOrder {
    public string Id { get; set; }; // This is the ID generated by Mersal's database
    public string ExternalReferenceId { get; set; } // This is the ID given by the service syncing with Mersal
}
```
